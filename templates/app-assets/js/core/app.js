...
(function(window, document, $) {
 ...
 $(document).ready(function() {
     $(document).on('click', '.setLanguage', function(){
         var lang = $(this).attr("data-lang");
         var link = $(this).attr("data-link");
		 
         $.ajax({
             url: 'actions/makeSession.php',
             type: 'post',
             data: {lang: lang},
             datatype: 'html',
             success: function(response){
                ...
                {
                    $("#error_language_session").fadeIn(1000, function()
                    {
                        $("#error_language_session").html('<div class="alert alert-danger"><span class="glyphicon glyphicon-info-sign"></span> &nbsp; '+response+' !!!!!</div>');
                    });
                }
             }
         });
