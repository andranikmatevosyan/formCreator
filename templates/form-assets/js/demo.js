	...
	$("#createForm").validate({
		rules:
	  {
	   ...
	   {		
		   ...
		   var general = $("#createForm").serialize();

           $.ajax({

            type : 'POST',
            url  : 'actions/save-form.php',
			data: {data: data, general: general},
            beforeSend: function()
            {	
                $("#error-form").fadeOut();
                $("#btnCreateForm").html('<span class="glyphicon glyphicon-transfer"></span> &nbsp; sending ...');
            },
            ...
            {						
                ...
                {
                    $("#error-form").fadeIn(1000, function()
                    {
                        $("#error-form").html('<div class="alert alert-danger"><span class="glyphicon glyphicon-info-sign"></span> &nbsp; '+response+' !!!!!</div>');
                        $("#btnCreateForm").html('<span class="icon-check2"></span> Save Form');
                    });
                }
           }
           });
